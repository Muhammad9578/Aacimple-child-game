...
class SixRowActivityView extends GetView<HomeController> {
  const SixRowActivityView({super.key});
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                     InkWell(
                       onTap: () {
                        // Check if there are at least 6 more phrases to navigate forward
                        if (controller.selectedIndex.value + 6 <
