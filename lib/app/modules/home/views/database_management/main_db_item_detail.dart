...
import 'package:aacimple/app/Utils/widgets/delete_dialog.dart';
...
class MainDbItemDetail extends StatelessWidget {
  MainDbItemDetail({super.key});
                    ...
                    Obx(() {
                      return Container(
                          ...
                          decoration: BoxDecoration(
                              border: Border.all(color: Colors.white)),
                          child: InkWell(
                            onTap: () => homeController.speak(homeController
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              ...
                              homeController.phraseImage.value = homeController
                          ...
                          InkWell(
                            onTap: () {
                              deleteRecord(onDelete: () {
                                ...
                                homeController.insertPhrase(false);
                                homeController.deleteSamplePhrase(true,
